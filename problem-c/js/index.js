...
gamesLost.forEach(function(game) {
...
let fumbleGames = huskyGames2016.filter(function(game) {
  if (game["fumbles"] > 0) {
    return true;
  } else {
    return false;
...
function mostYardsPassing(game1, game2) {
  ...
  if (game2["passing_yards"] === undefined) {
    return game1;
  }
...
let lostFumbles = huskyGames2016.filter(fumbledAndLostFilter);
console.log(lostFumbles);
